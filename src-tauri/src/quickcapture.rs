...
pub fn open_with_context(app: &AppHandle, customer_id: Option<i64>, system_id: Option<i64>) -> Result<(), AppError> {
    open_internal(app, customer_id, system_id)
}

fn open_internal(app: &AppHandle, override_customer_id: Option<i64>, override_system_id: Option<i64>) -> Result<(), AppError> {
    let window = app
