...
* Thirteen built in RMM and asset management plugin integrations: NinjaOne, Level.io, Snipe IT, Microsoft Intune, Iru (Apple MDM, formerly Kandji), Jamf Pro, Apple Business Manager, Tactical RMM, Atera, Pulseway, Kaseya VSA, Action1, and Datto RMM. Each is read only. Data is pulled in and linked to a local system on request, and existing fields are never overwritten automatically.
